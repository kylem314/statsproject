...
public class college_list {
    @GetMapping("/college_list")    // CONTROLLER handles GET request for /greeting, maps it to greeting() and does variable bindings
    public String eric_about(@RequestParam(name="name", required=false, defaultValue="World") String name, Model model) {
        ...
        return "college_list"; // returns HTML VIEW (greeting)
    }
}