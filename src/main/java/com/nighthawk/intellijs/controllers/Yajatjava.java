...
public class Yajatjava {
    ...
    @GetMapping("/yajat_about")    // CONTROLLER handles GET request for /greeting, maps it to greeting() and does variable bindings
...
////        model.addAttribute("last_updated", current_data.get("update").toString());
//
//            return "yajat_about";
//
//
...
//
//            JSONObject current_data = (JSONObject) jo.get("current");
//            System.out.println(current_data.get("temp_f"));
//
////
//////
//////
